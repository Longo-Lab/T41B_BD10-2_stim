...
wk_dir = paste0(rootdir, '/stim_ad_module_enrichment')
setwd(paste0(rootdir, '/stim_ad_module_enrichment'))
...
enrich(de_list, ad_list, gs, "AD_Modules", width=20, height=6)

# enrich for up/down genes
enrich(updown_list, ad_list, gs, "AD_Modules_Up-Down", width=20, height=6)
