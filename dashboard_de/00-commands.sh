...
sbatch -J T41B_BD10-2_stim --mem=5G -c 2 -t 01:00:00 -p interactive \
  ...
  --wrap "ml R/4.2.2; biodomain_correlation.R -n $nameset -g APPL/S -d BD10-2 -i Gene_id"
...
sbatch -J T41B_TBS --mem=5G -c 2 -t 01:00:00 -p interactive \
  -o %x/%A_biodomain_correlation_%x.log \
  --wrap "ml R/4.2.2; biodomain_correlation.R -n $nameset -g APPL/S -d TBS -i Gene_id"
